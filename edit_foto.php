        ...
        <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link " href="home.php" aria-expanded="false">
                ...
                <span class="hide-menu active">Images</span>
              </a>
            </li>
            <li class="sidebar-item">
    ...
    <div class="body-wrapper">
      ...
      <div class="card">
        ...
        <input type="text" name="fotoid" value="<?=$data['fotoid']?>" hidden>
                  <div class="mb-3">
                      <label for="judulfoto1" class="form-label">Judul Foto </label>
                      <input type="text" class="form-control"name="judulfoto" id="judulfoto1" value="<?=$data['judulfoto']?>">
                    </div>
                    <div class="mb-3">
                      <label for="deskripsifoto" class="form-label">Deskripsi Foto</label>
                      <input type="text" class="form-control" name="deskripsifoto" id="deskripsifoto"  value="<?=$data['deskripsifoto']?>">
                    </div>
                    <div class="mb-3">
                      <label for="lokasifile" class="form-label">Photo</label>
