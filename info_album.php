          ...
          <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Details Album</h5>
                <a class="btn btn-outline-secondary m-1"><?=$data2['namaalbum'];?></a>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal align-center" ><?php
                            $fotoid=$data['fotoid'];
                            $sql3=mysqli_query($conn,"select * from likefoto where fotoid='$fotoid'");
                            echo mysqli_num_rows($sql3); ?></p>
                        </td>
